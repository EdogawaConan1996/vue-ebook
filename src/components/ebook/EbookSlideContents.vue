  ...
  <div class="ebook-slide-contents">
    ...
    <div class="slide-contents-book-wrapper" v-show="!searchVisible">
      ...
      <div class="slide-contents-book-info-wrapper">
        <div class="slide-contents-book-title" v-if="metadata && metadata.title">{{metadata.title}}</div>
        <div class="slide-contents-book-author" v-if="metadata && metadata.creator">{{metadata.creator}}</div>
      </div>
