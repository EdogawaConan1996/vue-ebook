  ...
  <div class="store-shelf">
    ...
    <scroll class="store-shelf-scroll-wrapper"
      ...
      <shelf-search @onSearchClick="onSearchClick"
                    ...
                    ref="shelfSearch"
                    v-if="!isDataEmpty" />
      <shelf-list class="store-shelf-list"
                  :data="bookList"
                  :showType="showType"
                  ...
                  ref="bookShelf"
                  v-if="!isDataEmpty" />
      <shelf-list-empty class="book-shelf-empty"
                        v-if="isDataEmpty" />
    </scroll>
...
<script>
  ...
  import ShelfListEmpty from "../../components/shelf/ShelfListEmpty";
  global.ePub = Epub
