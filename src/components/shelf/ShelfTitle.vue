<template>
  <transition name="fade">
    <div class="shelf-title" :class="{'hide-shadow': ifHideShadow}" v-if="shelfTitleVisible">
      <div class="shelf-title-text-wrapper">
        <span class="shelf-title-text">{{title}}</span>
        <span class="shelf-title-sub-text" v-show="isEditMode">{{selectedText}}</span>
      </div>
      <div v-if="showClear" class="shelf-title-btn-wrapper shelf-title-left">
      ...
      <div v-if="showBack" class="shelf-title-btn-wrapper shelf-title-left">
